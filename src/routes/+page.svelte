<script lang="ts">
	import { IconClock, IconSettings, IconTrash } from '@tabler/icons-svelte';
...
<div class="relative">
	<Toast position="tr" />
	<div
		class="container min-w-full flex justify-between p-4 lg:p-10 flex-col lg:flex-row lg:max-h-screen"
	>
			...
			<section class="m-8">
				...
				<div>
					...
					<div class="flex gap-4 m-2 mb-8">
						...
						>
							<IconClock class="inline lg:hidden" /><span class="hidden lg:inline"
		...
		>
			<div class="flex flex-col gap-y-5 min-h-0">
				{#each $timeslotStore as tt, index (tt.uuid)}
					<div
						class="card p-4 flex-none ml-auto mr-0 lg:w-1/2"
